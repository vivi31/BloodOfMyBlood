...
public class Nivel3 implements Screen {
    ...
    private Nivel3.Movimiento estadoPersonaje = Nivel3.Movimiento.QUIETO;
    private Texture texturaPersonaje;

    public Nivel3(Juego juego, String sexo) {
        this.juego = juego;
        this.sexo = sexo;
    }
    ...
    private void crearHUD() {
        ...
        btnDerecha.addListener(new ClickListener() {
            ...
            public boolean touchDown(InputEvent event, float x, float y, int pointer, int button) {
                estadoPersonaje = Nivel3.Movimiento.DERECHA;
                return true;
            }

            @Override
            public void touchUp(InputEvent event, float x, float y, int pointer, int button) {
                estadoPersonaje = Nivel3.Movimiento.QUIETO;
            }
        ...
        btnIzquierda.addListener(new ClickListener() {
            @Override
            public boolean touchDown(InputEvent event, float x, float y, int pointer, int button) {
                estadoPersonaje = Nivel3.Movimiento.IZQUIERDA;
                return true;
            }
    ...
    private void cargarTexturas() {
        texturaFondo = new Texture("Fondos/fondoN3.gif");
    }
