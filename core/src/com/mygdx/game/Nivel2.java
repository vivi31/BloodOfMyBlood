...
public class Nivel2 implements Screen {
    ...
    private Nivel2.Movimiento estadoPersonaje = Nivel2.Movimiento.QUIETO;
    private Texture texturaPersonaje;

    public Nivel2(Juego juego, String sexo) {
        this.juego = juego;
        this.sexo = sexo;
    }
    ...
    private void crearHUD() {
        ...
        btnDerecha.addListener(new ClickListener() {
            ...
            public boolean touchDown(InputEvent event, float x, float y, int pointer, int button) {
                estadoPersonaje = Nivel2.Movimiento.DERECHA;
                return true;
            }

            @Override
            public void touchUp(InputEvent event, float x, float y, int pointer, int button) {
                estadoPersonaje = Nivel2.Movimiento.QUIETO;
            }
        ...
        btnIzquierda.addListener(new ClickListener() {
            @Override
            public boolean touchDown(InputEvent event, float x, float y, int pointer, int button) {
                estadoPersonaje = Nivel2.Movimiento.IZQUIERDA;
                return true;
            }
    ...
    private void cargarTexturas() {
        texturaFondo = new Texture("Fondos/fondoN2.gif");
    }
